...
- Suggest the best mode of transportation to the destination from Bangalore, India. Highlight any 
  benefits, such as scenic routes, breathtaking sea views, or picturesque landscapes they may encounter 
  along the way.
- Recommend the best stay locations in advance. Provide options that suit their preferences.Provide them the contacts and valid OpenStreetMap from Bangalore,India to the location suggestions made.
...
Provide option for the traveller to download the output make sure to include the images.
"""